...
from src.analysis.fit import fit_hyperplane, linear_predict
from src.analysis.plot import analyze_plot_results_together
from src.analysis.distortion_performance_composite import get_composite_performance_result
from src.analysis.binomial_simulation import get_ideal_correlation
...
def compare_correlate(config):
    ...
    addition_performance_results = get_multiple_model_distortion_performance_results(test_result_identifiers)
    performance_results.extend(addition_performance_results)
...
if __name__ == '__main__':
    ...
    config_filename = 's6_fr_pt_fr90_mega1_legend_update.yml'
