...
def run_extraction(image_tags,
                   original_dataset_tag,
                   early_stop,
                   save_results):
    img_mode = 'L'
    ...
    save_name_seed = 'image_metadata_plus_properties-v2'  
...
if __name__ == '__main__':
    ...
    _original_dataset_tag = 'val_256'
    image_tag_sets = [
        # ['pan', 'r3', 'b3'],
        # ['pan', 'r3', 'b3', 'n2'],  # note: DEF suspect, probably not noise added
        # ['pan', 'r3', 'b3', 'n3'],  # note: should have inherited down to 'b3'
        # ['pan_br', 'r3', 'b0'],
        # ['pan_br', 'r3', 'b0', 'n3'],
        # ['pan_br', 'r3', 'b6'],
        # ['pan_br', 'r3', 'b6', 'n3'],
        ...
        # ['pan', 'r3_br2', 'b3', 'nf3'],
        ['pan_msc1', 'rc3', 'bc3'],
        ['pan_msc1', 'rc3', 'bc3', 'nf3']
        ]

    _early_stop = False
    _save_results = True

    for image_tag_set in image_tag_sets:

        run_extraction(image_tag_set,
                       _original_dataset_tag,
                       _early_stop,
                       _save_results)
